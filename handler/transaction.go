...
func (h *transactionHandler) CreateTransaction(c *gin.Context) {
	...
	if err != nil {
		...
		response := helper.APIResponse("Failed to create transaction", http.StatusBadRequest, "error", errMessage)
		c.JSON(http.StatusBadRequest, response)
		return
	}
	...
	if err != nil {
		response := helper.APIResponse("Failed to create transaction", http.StatusBadRequest, "error", newTransaction)
		c.JSON(http.StatusBadRequest, response)
		return
	}
